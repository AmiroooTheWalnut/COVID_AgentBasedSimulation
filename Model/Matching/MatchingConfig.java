...
public class MatchingConfig {
    ...
    public boolean loadMatchConfig() {
        File f = new File("MatchingConfig.json");
        if (f.exists() && !f.isDirectory()) {
            ...
            try {
                ...
                System.out.println("Default matching files exist and they are ready!");
                return true;
            ...
            System.out.println("Default matching files don't exist!");
        }
        return false;
    }
